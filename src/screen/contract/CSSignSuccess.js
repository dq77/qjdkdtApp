...
@injectUnmount
class CSSignSuccess extends PureComponent {
  constructor (props) {
    super(props)
    this.state = {
      info: '',
  ...
  toContractDetail () {
    ...
    const { contractCode, processInstanceId, source } = this.props.faceExtraData
...
export default connect(mapStateToProps)(CSSignSuccess)
