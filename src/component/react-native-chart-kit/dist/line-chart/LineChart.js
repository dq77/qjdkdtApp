...
import { Circle, G, Path, Polygon, Polyline, Rect, Svg, Defs, LinearGradient, Stop } from 'react-native-svg'
...
var LineChart = /** @class */ (function (_super) {
  ...
  function LineChart () {
    ...
    _this.getPropsForDots = function (x, i) {
      var _a = _this.props; var getDotProps = _a.getDotProps; var chartConfig = _a.chartConfig
      if (typeof getDotProps === 'function') {
        return getDotProps(x, i)
      }
      var _b = chartConfig.propsForDots; var propsForDots = _b === void 0 ? {} : _b
      return __assign({ r: '4' }, propsForDots)
    }
    _this.renderDots = function (_a) {
      var data = _a.data; var width = _a.width; var height = _a.height; var paddingTop = _a.paddingTop; var paddingRight = _a.paddingRight; var onDataPointClick = _a.onDataPointClick
      var output = []
      var datas = _this.getDatas(data)
      var baseHeight = _this.calcBaseHeight(datas, height)
      var _b = _this.props; var getDotColor = _b.getDotColor; var _c = _b.hidePointsAtIndex; var hidePointsAtIndex = _c === void 0 ? [] : _c; var _d = _b.renderDotContent; var renderDotContent = _d === void 0 ? function () {
        return null
      } : _d
      const dataList = []
      ...
      output.push(renderDotContent(dataList))
      return output
    }
    _this.renderScrollableDot = function (_a) {
      var data = _a.data; var width = _a.width; var height = _a.height; var paddingTop = _a.paddingTop; var paddingRight = _a.paddingRight; var scrollableDotHorizontalOffset = _a.scrollableDotHorizontalOffset; var scrollableDotFill = _a.scrollableDotFill; var scrollableDotStrokeColor = _a.scrollableDotStrokeColor; var scrollableDotStrokeWidth = _a.scrollableDotStrokeWidth; var scrollableDotRadius = _a.scrollableDotRadius; var scrollableInfoViewStyle = _a.scrollableInfoViewStyle; var scrollableInfoTextStyle = _a.scrollableInfoTextStyle; var _b = _a.scrollableInfoTextDecorator; var scrollableInfoTextDecorator = _b === void 0 ? function (x) { return '' + x } : _b; var scrollableInfoSize = _a.scrollableInfoSize; var scrollableInfoOffset = _a.scrollableInfoOffset
      var output = []
      var datas = _this.getDatas(data)
      var baseHeight = _this.calcBaseHeight(datas, height)
      var vl = []
    ...
    _this.renderShadow = function (_a) {
      var width = _a.width; var height = _a.height; var paddingRight = _a.paddingRight; var paddingTop = _a.paddingTop; var data = _a.data; var useColorFromDataset = _a.useColorFromDataset
      if (_this.props.bezier) {
        return _this.renderBezierShadow({
          ...
          data: data,
          fillShadowGradient: _a.chartConfig.fillShadowGradient,
    ...
    _this.renderLine = function (_a) {
      var width = _a.width; var height = _a.height; var paddingRight = _a.paddingRight; var paddingTop = _a.paddingTop; var data = _a.data; var linejoinType = _a.linejoinType
      if (_this.props.bezier) {
    ...
    _this.getBezierLinePoints = function (dataset, _a) {
      var width = _a.width; var height = _a.height; var paddingRight = _a.paddingRight; var paddingTop = _a.paddingTop; var data = _a.data
    ...
    _this.renderBezierLine = function (_a) {
      var data = _a.data; var width = _a.width; var height = _a.height; var paddingRight = _a.paddingRight; var paddingTop = _a.paddingTop
      return data.map(function (dataset, index) {
    ...
    _this.renderBezierShadow = function (_a) {
      ...
      return data.map(function (dataset, index) {
        ...
        return (<Path d={d} key={`${index}`} fill={'url(#fillShadowGradient' + (useColorFromDataset ? '_' + index : '') + ')'} strokeWidth={0}/>)
      })
    }
    _this.renderLegend = function (width, legendOffset) {
      var _a = _this.props.data; var legend = _a.legend; var datasets = _a.datasets
  ...
  LineChart.prototype.render = function () {
    var _a = this.props; var width = _a.width; var height = _a.height; var data = _a.data; var _b = _a.withScrollableDot; var withScrollableDot = _b === void 0 ? false : _b; var _c = _a.withShadow; var withShadow = _c === void 0 ? true : _c; var _d = _a.withDots; var withDots = _d === void 0 ? true : _d; var _e = _a.withInnerLines; var withInnerLines = _e === void 0 ? true : _e; var _f = _a.withOuterLines; var withOuterLines = _f === void 0 ? true : _f; var _g = _a.withHorizontalLines; var withHorizontalLines = _g === void 0 ? true : _g; var _h = _a.withVerticalLines; var withVerticalLines = _h === void 0 ? true : _h; var _j = _a.withHorizontalLabels; var withHorizontalLabels = _j === void 0 ? true : _j; var _k = _a.withVerticalLabels; var withVerticalLabels = _k === void 0 ? true : _k; var _l = _a.style; var style = _l === void 0 ? {} : _l; var decorator = _a.decorator
    var isShowLine = _a.isShowLine
    var onDataPointClick = _a.onDataPointClick; var _m = _a.verticalLabelRotation; var verticalLabelRotation = _m === void 0 ? 0 : _m; var _o = _a.horizontalLabelRotation; var horizontalLabelRotation = _o === void 0 ? 0 : _o; var _p = _a.formatYLabel; var formatYLabel = _p === void 0 ? function (yLabel) { return yLabel } : _p; var _q = _a.formatXLabel; var formatXLabel = _q === void 0 ? function (xLabel) { return xLabel } : _q; var segments = _a.segments; var _r = _a.transparent; var transparent = _r === void 0 ? false : _r; var chartConfig = _a.chartConfig
    var scrollableDotHorizontalOffset = this.state.scrollableDotHorizontalOffset
    var _s = data.labels; var labels = _s === void 0 ? [] : _s
    var _t = style.borderRadius; var borderRadius = _t === void 0 ? 0 : _t; var _u = style.paddingTop; var paddingTop = _u === void 0 ? 16 : _u; var _v = style.paddingRight; var paddingRight = _v === void 0 ? 64 : _v; var _w = style.margin; var margin = _w === void 0 ? 0 : _w; var _x = style.marginRight; var marginRight = _x === void 0 ? 0 : _x; var _y = style.paddingBottom; var paddingBottom = _y === void 0 ? 0 : _y
    var config = {
      chartConfig,
      width: width,
      height: height,
    ...
    var count = Math.min.apply(Math, datas) === Math.max.apply(Math, datas) ? 4 : 4
    ...
    return (<View style={style}>
      <Svg height={height + paddingBottom + legendOffset} width={width - margin * 2 - marginRight}>
        ...
        <G x="0" y={legendOffset}>
          ...
          <G>
            {withVerticalLabels &&
            this.renderVerticalLabels(__assign(__assign({}, config), { labels: labels, paddingTop: paddingTop, paddingRight: paddingRight + dp(54), formatXLabel: formatXLabel }))}
          </G>
          <G>
            {isShowLine && this.renderLine(__assign(__assign(__assign({}, config), chartConfig), { paddingRight: paddingRight + dp(54), paddingTop: paddingTop, data: data.datasets }))}
          </G>
          <G>
            {isShowLine && withShadow &&
            this.renderShadow(__assign(__assign({}, config), { data: data.datasets, paddingRight: paddingRight + dp(54), paddingTop: paddingTop, useColorFromDataset: chartConfig.useShadowColorFromDataset }))}
          </G>
          <G>
            {withDots &&
            this.renderDots(__assign(__assign({}, config), { data: data.datasets, paddingTop: paddingTop, paddingRight: paddingRight + dp(54), onDataPointClick: onDataPointClick }))}
          </G>
          <G>
            {withScrollableDot &&
